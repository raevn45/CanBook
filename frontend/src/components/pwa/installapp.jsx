...
export default function InstallApp() {
  ...
  useEffect(() => {
    ...
    const handleBeforeInstall = (event) => { event.preventDefault(); setInstallEvent(event); };
    const handleInstalled = () => { setInstalled(true); setInstallEvent(null); setShowHelp(false); };
