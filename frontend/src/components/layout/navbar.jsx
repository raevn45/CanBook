  ...
  return (
    <>
      ...
      <motion.header className="navbar interactive-navbar" initial={{ y: -70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", stiffness: 260, damping: 24 }}>
        <Link to="/" className="brand brand-home-button" aria-label="CanBook home" title="CanBook home"><motion.span className="brand-mark" whileHover={{ rotate: 6, scale: 1.08 }} whileTap={{ scale: 0.92 }}><span>C</span><b>B</b></motion.span></Link>
